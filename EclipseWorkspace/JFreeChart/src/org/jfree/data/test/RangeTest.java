...
public class RangeTest {
    ...
    public void setUp() throws Exception {
        exampleRange = new Range(-10, 20); // Range of -10 to 20 }
    }
    ...
    public void intersectNormalTest() {
        ...
        assertTrue("The statement should be true", exampleRange.intersects(1, 5)); // Range of 1 to 5 }
    }

    @Test
    public void intersectBoundaryTest() {

        assertTrue("The statement should be true", exampleRange.intersects(1, 1)); // Range of 1 to 1 }
    }
    ...
    public void shiftValidZero() {
        Range shiftRange = new Range(-10, 15); // make a new range to shift
        shiftRange = Range.shift(shiftRange, 0); // shift the range by 0
        assertEquals("The Upperbound should be -10",
                -10, shiftRange.getLowerBound(), .000000001d); // check to see if the upper bound is -10
    }
    ...
    @Test(expected = java.lang.NullPointerException.class) // test to see if the shift method throws a null pointer
                                                           // exception
    public void shiftPositive() { // test to see if the shift method throws a null pointer exception
        Range shiftRange = new Range(-10, 15); // make a new range to shift
        shiftRange = Range.shift(null, 15); // shift the range by 15
    }
    ...
    public void TestNullAndValidUpperBound() {
        ...
        assertEquals("Expected upper bound is 4.0. Actual upper bound is " + upper_bound, 4.0, upper_bound,
                .000000001d);
    }
    ...
    public void TestValidAndNullUpperBound() {
        Range range = Range.combine(new Range(2, 4), null);
        double upper_bound = range.getUpperBound();
        assertEquals("Expected lower bound is 4.0. Actual lower bound is " + upper_bound, 4.0, upper_bound,
                .000000001d);
    }
    ...
    public void TestValueInRangeLowerBound() {
        ...
        assertEquals("Expected lower bound is 1.0. Actual lower bound is " + value_in_range, 1.0, value_in_range,
                .000000001d);
    }
    ...
    public void TestValueInRangeUpperBound() {
        ...
        assertEquals("Expected upper bound is 10.0. Actual upper bound is " + value_in_range, 10.0, value_in_range,
                .000000001d);
    }
    ...
    public void TestValueGreaterThanMaxUpperBound() {
        Range range = Range.expandToInclude(new Range(1, 10), 12);
        double value_in_range = range.getUpperBound();
        assertEquals("Expected upper bound is 12.0. Actual upper bound is " + value_in_range, 12.0, value_in_range,
                .000000001d);
    }
    ...
    public void TestValueLessThanMinLowerBound() {
        ...
        double value_in_range = range.getLowerBound();
        assertEquals("Expected lower bound is 2.0. Actual lower bound is " + value_in_range, 2.0, value_in_range,
                .000000001d);
    }
    ...
    public void TestNullRangeValueUpperBound() {
        ...
        double upper_bound = range.getUpperBound();
        assertEquals("Expected upper bound is 5.0. Actual upper bound is " + upper_bound, 5.0, upper_bound,
                .000000001d);
    }
    ...
    public void TestNullRangeValueLowerBound() {
        ...
        Range range = Range.expandToInclude(n_range, 5);
        double lower_bound = range.getLowerBound();
        assertEquals("Expected lower bound is 5.0. Actual lower bound is " + lower_bound, 5.0, lower_bound,
                .000000001d);
    }
    ...
    public void TestNegativeValueLowerBound() {
        ...
        double lower_bound = range.getLowerBound();
        assertEquals("Expected lower bound is -1.0. Actual lower bound is " + lower_bound, -1.0, lower_bound,
                .000000001d);
    }
